<h1>Run this model on Hugging Face <img src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" alt="hugging face logo" style="height: 25px; width:25px;"/></h1>  
Run the model on Hugging Face(https://huggingface.co/spaces/2024madhacks/mole_class)
